#pydroid 3 игра лабиринт
#периметр статические стены
#стеки лабиринта динамически меняют узор проходов
#нужно из точки A дойти до точки B
#при выигрыше игра начинается заново
